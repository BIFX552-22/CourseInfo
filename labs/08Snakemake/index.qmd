...
If you are working on the Hood cluster, you can copy the data for this lab from `...`, or you can fetch the data from [figshare](https://ndownloader.figshare.com/files/35058796) and unzip locally.
...
::: callout-note
## Challenge 5
Modify your *countreads* rule such that we can supply `snakemake` with "trimmed.ref1_1.fq.count" and get the following outputs:
* `trimmed/ref1_1.fq`
* `ref1_1.trimmed.fq`
:::
