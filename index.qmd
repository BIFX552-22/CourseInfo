...
snakemake1 <- '[Snakemake Intro](labs/08Snakemake)'#(https://carpentries-incubator.github.io/snakemake-novice-bioinformatics/)
...
matrix(dimnames = list(NULL, c('Week', 'Date', 'Topics', 'Lab')),
       ...
       data = c( 1, 'Aug 25', paste(intro,
                ...
                10, 'Oct 27',       wrangling,                    'Snakemake',
                11, 'Nov  3',       variant_calling,              '',
                12, 'Nov 10',       '',                '',
                13, 'Nov 17',       '',                  '',
