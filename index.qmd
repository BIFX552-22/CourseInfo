...
snakemake1 <- '[Snakemake Intro](labs/08Snakemake)'#(https://carpentries-incubator.github.io/snakemake-novice-bioinformatics/)(1 - 3 or 4)
snakemake2 <- '[Advanced Snakemake](https://carpentries-incubator.github.io/snakemake-novice-bioinformatics/)' # (5 - 9) (maybe do 6 in class?)
...
matrix(dimnames = list(NULL, c('Week', 'Date', 'Topics', 'Lab')),
       ...
       data = c( 1, 'Aug 25', paste(intro,
                ...
                12, 'Nov 10',       bioc_proj1,                   bioc_proj2,
                13, 'Nov 17',       RNA_seq_setup,                RNA_seq_analysis,
                14, 'Nov 24',       dimensionality,              'Thanksgiving, No Class',
