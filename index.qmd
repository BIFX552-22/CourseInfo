...
unix1       <- paste0('[Unix](',                  shell_genomics, ') (2 - 4)')
unix2       <- paste0('[Advanced Unix](',         shell_genomics, ') (5 - 6)')
...
epi4bioinfo <- '[Epidemiology for bioinformatics](https://bioc2022.bioconductor.org/abstracts/paper43/)'
...
### Other Carpentries
bioc_proj <- '[Bioconductor Project](https://carpentries-incubator.github.io/bioc-project/index.html)'
...
snakemake1 <- '[Snakemake Intro](https://carpentries-incubator.github.io/snakemake-novice-bioinformatics/)'
snakemake2 <- '[Advanced Snakemake](https://carpentries-incubator.github.io/snakemake-novice-bioinformatics/)'
...
matrix(dimnames = list(NULL, c('Week', 'Date', 'Topics', 'Lab')),
       byrow = TRUE, ncol = 4,
       data = c( 1, 'Aug 25',       git,                    paste(intro,
                                                                 '[GitHub / DockerHub](labs/01git)'),
                 2, 'Sep  1',       Rintro,                      'R Markdown / Quarto',
                 3, 'Sep  8', paste(Rdfs,
                                    Rcontrol,       sep = ', '), 'P-Hacking',
                 4, 'Sep 15', paste(Rgraphics,
                                    Rvectorization,
                                    Rfunctions,     sep = ', '), 'COVID Data',
                 5, 'Sep 22',       Rdata,                        rna_data, 
                 6, 'Sep 29', paste(Joining,
                                    RswTips,        sep = ', '),  epi4bioinfo,
                 7, 'Oct  6',      'Exam',                       'Exam review',
                 8, 'Oct 13', paste(proj_org, 
                                    shell_intro,
                                    unix1, sep = ', '),           unix2,
                 9, 'Oct 20',       wrangling,                    variant_calling,
                10, 'Oct 27',       bioc_proj,                    bioc_annotation,
                11, 'Nov  3',       RNA_seq_setup,                RNA_seq_analysis,
                12, 'Nov 10',       dimensionality,               single_cell,
                13, 'Nov 17',       snakemake1,                  'Snakemake Pipeline',
                14, 'Nov 24',       snakemake2,                  'Thanksgiving, No Class',
