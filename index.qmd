...
-   Code of Conduct: We want to foster a safe, enjoyable and productive learning environment. People like you add value to our program. To meet this end, all participants will be expected to follow the [course code of conduct](https://github.com/BIFXapps/BIFX552/blob/master/code_of_conduct.md) located in the course documents on Blackboard.
...
Recorded coding demos will be provided weekly, and in-class coding labs will be scheduled on Thursday evenings throughout the term at 5:30 PM (unless otherwise specified). Because Bioinformatics is such a fast-moving field, demos and labs will be based on up-to-date, publicly available material from cutting edge experts from the [Data Carpentry](https://datacarpentry.org/) and [Bioconductor](https://bioc2022.bioconductor.org/workshops) communities.
...
For the course project, students will have the opportunity to develop an R Shiny app with examples of the material and techniques we will be covering throughout the course. In-class lab time will be devoted to this each week, and the final prject will be due at the end of the course.
...
In the event of severe weather resulting in the closure of Hood College and the cancellation of an in-person lab, the lab will be held virtually at the scheduled time and posted on Blackboard for asynchronous viewing.

### Tentative Class Schedule

An R proficiency quiz will be administered during the first week of class. Depending on how well the class does on this quiz, we may update this schedule.
