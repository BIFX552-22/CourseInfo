...
unix1       <- paste0('[Unix](',                  shell_genomics, ') (2 - 3)')
unix2       <- paste0('[Advanced Unix](',         shell_genomics, ') (4 - 6)')
...
matrix(dimnames = list(NULL, c('Week', 'Date', 'Topics', 'Lab')),
       ...
       data = c( 1, 'Aug 25', paste(intro,
                 ...
                 8, 'Oct 13', paste(shell_intro,
                                    unix1, sep = ', '),    paste('Exam review',
                                                                  proj_org),
                 9, 'Oct 20',       unix2,                        dimensionality,
                10, 'Oct 27',       wrangling,                    variant_calling,
                11, 'Nov  3',       bioc_proj,                    bioc_annotation,
                12, 'Nov 10',       RNA_seq_setup,                RNA_seq_analysis,
